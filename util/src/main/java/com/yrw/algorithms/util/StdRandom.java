...
public final class StdRandom {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            System.out.println(String.format("%2d ", uniform(100)));
            System.out.println(String.format("%8.5f ", uniform(10.0, 99.0)));
            System.out.println(String.format("%5b ", bernoulli(0.5)));
            System.out.println(String.format("%7.5f ", gaussian(9.0, 0.2)));
            System.out.println(String.format("%1d ", discrete(probabilities)));
            System.out.println(String.format("%1d ", discrete(frequencies)));
            System.out.println(String.format("%11d ", uniform(100000000000L)));
            StdRandom.shuffle(a);
            for (String s : a)
